...
jQuery(function ($) {
    ...
    if (typeof tinyMCE != 'undefined') {
        ...
        tinyMCE.init({
            ...
            theme_advanced_buttons1: "formatselect,fontsizeselect,|,justifyleft,justifycenter,justifyright,justifyfull,|,bold,italic,underline,|,outdent,indent,forecolor,backcolor,link,unlink,|,bullist,numlist,blockquote,|,hr,sub,sup,undo,redo,removeformat",
            theme_advanced_buttons2: "table,tablecontrols,row_props,cell_props,delete_col,delete_row,col_after,col_before,row_after,row_before,split_cells,merge_cells,|,image,media,charmap,|,search,replace,|,code,fullscreen,",
